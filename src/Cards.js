...
<article className="card card--1">
  ...
  <div className="card__info">
    <span className="card__category"> INFO</span>
    <h3 className="card__title">Pranay Harwani</h3>
    <span className="card__by">Web <a href="#" className="card__author" title="author">Developer</a></span>
  </div>
</article>
